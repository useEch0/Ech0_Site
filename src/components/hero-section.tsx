...
export function HeroSection({
  ...
  return (
    <section className="flex flex-col items-center justify-center pt-12 text-center bg-gradient-to-b from-white to-teal-50/30 dark:from-emerald-800 dark:to-emerald-700/30">
