          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                Ech0 is designed with privacy-first principles, ensuring your data stays completely under your control.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 dark:from-teal-950 dark:via-cyan-950 dark:to-blue-950 border border-teal-200 dark:border-teal-800 rounded-3xl p-12 shadow-lg">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-teal-800 dark:text-teal-200 leading-relaxed"> Ech0 is a <strong>free, open-source</strong> publishing platform built with privacy and autonomy at its core. We believe your thoughts and creations should always belong to you — not to a company or a cloud. When you use Ech0, your data stays on your server, under your control, fully private unless you choose to share it. Your mind, your network, your rules. </p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-20">
              <div className="flex items-center justify-center gap-4 mb-12">
                ...
                <h2 className="text-3xl font-bold tracking-tight">How Ech0 Works</h2>
              </div>
